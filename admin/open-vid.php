...
<body>
    ...
    <div class="container my-5">
        <div class="row">
            ...
            <?php
        $uid = $_GET['vid'];
       $qry = "SELECT * FROM `video` WHERE  `vid` = '$uid'";
...
?>
        ...
        <video src="uploaded/<?php echo $data['image'] ?>" style="height:600px; width:600px;object-fit:cover;border-radius:20px;" alt="" width="100%" height="auto" controls></video>
         <div class="my-2 mx-2">
                     ...
                     $runn = mysqli_num_rows($run);
                      if ($runn > 0) {
                          while ($data = mysqli_fetch_assoc($run)) {
                                ?>
         <li class="trending-story mt-3">
            <div class="row">
                <div class="col-lg-5">
                    <video src="uploaded/<?php echo $data['image']?>" class="ml-3" style=" width: 150px; height:150px;object-fit:cover;border-radius:17px;" width="100%" height="auto" alt=""></video>
                </div>
                <div class="col-lg-7">
                    <button class="text-dark mt-2 ml-3" style="opacity: 0.8;">
                        <?php echo $data['category'] ?>
                    </button><br><a href="" class="text-dark">
                <p class="mt-4">
                    <a href="open-vid.php?vid=<?php echo $data['vid']?>" class="text-dark ml-3" >
                    <?php echo $data['desc'] ?>
                </a>
            </p>
              </a>
